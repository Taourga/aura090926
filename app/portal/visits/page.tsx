...
export default async function VisitsPage() {
  ...
  return <PortalShell profile={profile}>
    ...
    {profile.role === "patient" && <section className="card" style={{ marginBottom: 18 }}><div className="card-header"><div><h2>Prévenir l’accueil</h2><p className="card-subtitle">Deux personnes maximum, entre 13 h et 17 h, pour une durée maximale d’une heure.</p></div></div><div className="card-body"><VisitForm /></div></section>}
