...
export default async function InformationPage() {
  ...
  return <PortalShell profile={profile}>
    ...
    <div className="dashboard-grid">
      <div className="stack">
        <section className="card"><div className="card-header"><div><h2>Repères pratiques</h2><p className="card-subtitle">Horaires à connaître pendant votre séjour.</p></div></div><div className="card-body"><div className="list"><div className="list-row" style={{ gridTemplateColumns: "150px minmax(0,1fr)" }}><div className="time">Repas</div><div><div className="row-title">8 h · 12 h · 19 h</div><div className="row-meta">Petit-déjeuner, déjeuner et dîner. Consultez les menus pour le détail.</div></div></div><div className="list-row" style={{ gridTemplateColumns: "150px minmax(0,1fr)" }}><div className="time">Jardin</div><div><div className="row-title">Ouvert de 8 h 30 à 19 h 30</div><div className="row-meta">Merci de respecter les consignes de l’unité.</div></div></div><div className="list-row" style={{ gridTemplateColumns: "150px minmax(0,1fr)" }}><div className="time">Patio</div><div><div className="row-title">Ouvert jusqu’à 22 h</div><div className="row-meta">Accès dans le respect du calme de la clinique.</div></div></div><div className="list-row" style={{ gridTemplateColumns: "150px minmax(0,1fr)" }}><div className="time">Ascenseurs</div><div><div className="row-title">Fonctionnels jusqu’à 22 h maximum</div><div className="row-meta">Après cet horaire, rapprochez-vous de l’équipe si besoin.</div></div></div><div className="list-row" style={{ gridTemplateColumns: "150px minmax(0,1fr)" }}><div className="time">Médicaments</div><div><div className="row-title">Rappels : 8 h · 12 h · 18 h · 21 h</div><div className="row-meta">Suivez toujours les consignes personnalisées de l’équipe soignante.</div></div></div></div></div></section>
